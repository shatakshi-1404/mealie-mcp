...
T = TypeVar("T", bound="UpdateHouseholdPreferences")


@_attrs_define
class UpdateHouseholdPreferences:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_household_preferences = cls(
        ...
        update_household_preferences.additional_properties = d
        return update_household_preferences
