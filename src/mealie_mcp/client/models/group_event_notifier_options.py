...
T = TypeVar("T", bound="GroupEventNotifierOptions")


@_attrs_define
class GroupEventNotifierOptions:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        group_event_notifier_options = cls(
        ...
        group_event_notifier_options.additional_properties = d
        return group_event_notifier_options
